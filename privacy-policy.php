...
<div class="main-banner header-text" id="top">
    <div class="Modern-Slider Modern-Slider-Page">
        <div class="item item-1">
            <div class="img-fill" style="background-image: url('assets/images/page-heading-bg.jpg');">
                <div class="bg-fill">
                    <div class="text-content">
                        <h6></h6>
                        <h4>Privacy Policy</h4>

                        <p>Reviun Ltd. Privacy Policy
...
<div class="more-info" id="about" style="margin-top: 40px; margin-bottom:40px">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 align-self-center">
                            <div class="right-content">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 wow bounceInUp" data-wow-delay=".2s">

                                        <h1>Privacy Policy for Reviun Ltd</h1> <br>

                                        <p>At Reviun Ltd, accessible from https://reviun.co, one of our main priorities
                                            is the privacy of our visitors. This Privacy Policy document contains types
                                            of information that is collected and recorded by Reviun.co and how we use
                                            it.</p>
                                        ...
                                        <p>This Privacy Policy applies only to our online activities and is valid for
                                            ...
                                            and/or collect in Reviun.co. This policy is not applicable to any
                                        ...
                                        <p>Reviun.co follows a standard procedure of using log files. These files log
                                        ...
                                        <p>Like any other website, Reviun.co uses 'cookies'. These cookies are used to
                                        ...
                                        <p>Reviun.co's Privacy Policy does not apply to other advertisers or websites.
                                        ...
                                        <p>Reviun.co does not knowingly collect any Personal Identifiable Information
